...
namespace sensor{
    ...
    /**
     * This class notify when a modification is made to a file that modifies the context of the sensor
     */
    class Notifier {
    private :
	 ...
	 * @warning: dispose the old waits, but does not reset the signal slots
	 */
	void configure (const std::string & cgroupPath, const std::string & configDirPath);
